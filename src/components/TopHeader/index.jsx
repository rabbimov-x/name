...
const TopHeader = ()=>{
    return(
        <HeaderStyle>
            <LightHeader>
                <Container pd = "10px">
                  <Div display = "flex" w= "50%" align="center">
                  ...
                  <Div display = "flex" w = "auto" align = "center" mr = "0 0 0 auto">
                        <LinkA href="/usd" >
                            <Icon.Location color = " var(--cl-red)" mr = "0 10px 0 0" />
                            USD                     
                        </LinkA>
            ...
            <DarkHeader pd = "15px 0 15px 0">
                <Container>
                    ...
                    <Col6 display = "flex" align = "center" >
                        <DivIn>
                            <DivIn.Sellect >
                    ...
                    <Col3 display = "flex" align = "center" pd = "5px">
